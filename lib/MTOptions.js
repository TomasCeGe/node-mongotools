/*
 * File: MTOptions.js                                                          *
 * Project: node-mongotools                                                    *
 * File Created: Friday, 1st July 2022 10:19:28                                *
 * Author: Tomás Muniesa (tomas@cege.es)                                       *
 * -----                                                                       *
 * Last Modified: Friday, 1st July 2022 14:57:43                               *
...
class MTOptions {
  constructor(options) {
    ...
    this.collection = "collection" in opt ? opt.collection:null;
    ...
    this.dropboxPath = "dropboxPath" in opt ? opt.dropboxPath : 'backup';
